...
// Removed unused notesCover import
        ...
        return(
            <div className="row">
                <div className="gallery">
                    <a target="_blank" href="img_5terre.jpg" rel="noopener noreferrer">
                ...
                <div className="gallery">
                    <a target="_blank" href="img_forest.jpg" rel="noopener noreferrer">
                        <img src="https://res.cloudinary.com/duaooyuju/image/upload/v1743929811/download_ifdr3r.jpg" alt="Weapon" width="600" height="400" />
                    </a>
                    <div className="desc">Exhibit - 1 : Potential Murder Weapon</div>
                </div>

                <div className="gallery">
                    <a target="_blank" href="img_lights.jpg" rel="noopener noreferrer">
                ...
                <div className="gallery">
                    <a target="_blank" href="img_mountains.jpg" rel="noopener noreferrer">
